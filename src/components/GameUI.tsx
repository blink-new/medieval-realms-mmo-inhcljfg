      ...
      <div className="absolute top-4 left-4 right-4 flex justify-between items-start z-10">
        ...
        <Card className="bg-card/80 backdrop-blur-sm border-accent/30 p-4">
          <div className="flex items-center space-x-4">
            <div 
              className="w-12 h-12 rounded-full border-2 border-accent/50 flex items-center justify-center"
          ...
          <div className="flex space-x-2">
            ...
            {character.class === 'warrior' && (
              <>
                <Button 
                  size="sm" 
                  className="w-12 h-12 bg-primary/80 hover:bg-primary text-primary-foreground"
                  title="Sword Strike"
                >
                  ⚔️
                </Button>
